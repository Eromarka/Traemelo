...
export const BottomNav = () => {
    ...
    const tabs = [
        ...
        { name: 'Directorio', icon: 'explore', path: '/directory' },
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 px-5 pb-4">
            <div className="mx-auto max-w-md glass-card-intense !bg-white/10 border-white/20 rounded-2xl px-6 py-2.5 flex justify-between items-center shadow-2xl backdrop-blur-2xl">
                {tabs.map((tab) => {
                        ...
                        return (
                            ...
                            >
                                <div className="relative flex h-6 w-6 items-center justify-center">
                                    <div 
                                        className={`size-6 rounded-full bg-primary/20 ring-1 transition-all flex items-center justify-center overflow-hidden ${isActive ? 'ring-primary border border-primary/20' : 'ring-white/20'}`}
                                    >
                                        {avatarUrl ? (
                                    ...
                                    {isActive && (
                                        <div className="absolute -bottom-2 size-1 bg-primary rounded-full shadow-[0_0_8px_#38bdf8]"></div>
                                    )}
                                </div>
